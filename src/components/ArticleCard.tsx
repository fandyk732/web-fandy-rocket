...
export default function ArticleCard({ article }: ArticleCardProps) {
  return (
    <Link
      ...
      className="group bg-card border border-border rounded-2xl overflow-hidden card-hover flex flex-col cursor-pointer block"
      aria-label={`Article: ${article.title}`}
    >
      <article className="flex flex-col flex-1 h-full">
        {/* Cover gradient */}
        <div className={`relative h-36 bg-gradient-to-br ${article.gradient || 'from-blue-500/20 to-purple-500/20'} flex-shrink-0`}>
