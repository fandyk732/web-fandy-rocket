...
export default function HeroSection() {
  return (
    ...
    >
      ...
      {/* Noise texture */}
      <div className="absolute inset-0 noise-overlay opacity-60" aria-hidden="true" />
      {/* Radial glow */}
      <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            ...
            <div className="fade-slide-up-delay-1">
              <span className="inline-flex items-center gap-2 mono-label text-muted-foreground border border-border px-4 py-2 rounded-full bg-card/50 backdrop-blur-sm">
            ...
            <div className="fade-slide-up-delay-4 flex flex-col sm:flex-row gap-4">
              <Link
                href="/projects"
                className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-primary text-primary-foreground font-semibold rounded-xl hover:bg-accent transition-all duration-300 hover:scale-105 gold-glow-sm"
              >
                Explore My Work
                <svg
              ...
              <Link
                href="/about"
                className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-transparent text-foreground font-semibold rounded-xl border border-border hover:border-primary/50 hover:bg-muted/30 transition-all duration-300"
              >
                About Me
              </Link>
            </div>
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="lg:pl-12 flex flex-col gap-8">
              ...
              {/* Current role */}
              <div className="flex items-start gap-3 p-4 bg-card border border-border rounded-xl border-t">
